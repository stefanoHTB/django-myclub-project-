...
SECRET_KEY = 'django-insecure-h$+)dcejcfs#)&#4r&qy(f0ie$fd-fo4!qo94$r%7%2e9-x=mk'
...
LOGIN_REDIRECT_URL = ('home') #we qadded this because django by default redirects to accounts/profile after we login
